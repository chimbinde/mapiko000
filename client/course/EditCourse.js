    ...
    return (
        <div className={classes.root}>
             ...
             auth.isAuthenticated().user && auth.isAuthenticated().user._id == course.instructor._id &&
                (<span className={classes.action}><Button variant="contained" color="secondary" onClick={clickSubmit}>Salvar</Button>
                    </span>)
            }
                />
                ...
                <div>
                <CardHeader
                  title={<Typography variant="h6" className={classes.subheading}>Aulas - Editar e Recarregar</Typography>
                }
